...
// Example Query: "What NIACs are taking place in Europe or Asia regions?"


// Step 0: Define target region codes into one variable and conflict-type filters
...
Do not include any text except the generated Cypher statement.
 Do not include the word "cypher". Do not use code backticks like ```
